...
:: Копирование файла со строками в каталог для скомпилированных
:: классов для последующей упаковки в jar вместе с классами.
COPY "src\fileWithStrings.txt" "classes\fileWithStrings.txt"
