	...
	<main class="page-main">
		...
		<?php
			try {
				...
				$sql = 'SELECT chairName, (SELECT facultyName FROM faculties 
							WHERE chairs.facultyId = faculties.id) AS facultyName,
						chairHead, chairPhone FROM chairs;';
				$res = $pdo->query($sql);
				if ($res->rowCount() == 0) { 
