...
<head>
	...
	<![endif]-->
	<title>Работа №1, Версия 2 (Факультеты)</title>
	...
	<main class="page-main">
		...
		<div class="clearfix">
			...
			<div class="task1-form-wrapper float-left">
				...
				<form class="task1-form" action="subtype2-facultet.php"
			...
			<div class="vertical-menu-wrapper float-rigth">
				...
				<a class="task1-link-version" href="../subType1/subtype1-facultet.php"
