<?php
	...
	if (!$isFirstRequest) {
		$rawChairsName = filter_input($requestType, 'chairsName');
		$rawEmployeeName = filter_input($requestType, 'employeeName');
		$rawHomeAddress = filter_input($requestType, 'homeAddress');
		$rawEmployeeAge = filter_input($requestType, 'employeeAge');
		$rawEmployeePhone = filter_input($requestType, 'employeePhone');
...
<head>
	...
	<![endif]-->
	<title>Работа №1, Версия 2 (Сотрудники)</title>
	...
	<main class="page-main">
		...
		<div class="clearfix">
			...
			<div class="task1-form-wrapper float-left">
				...
				<form class="task1-form" action="subtype2-employees.php"
					method="post">
			...
			<div class="vertical-menu-wrapper float-rigth">
				<ul class="menu-list">
					...
					<li><a href="subtype2-chairs.php">Кафедры</a></li>
					<li class="active"><a href="#">Сотрудники</a></li>
				</ul>
				<a class="task1-link-version" href="../subType1/subtype1-employees.php"
