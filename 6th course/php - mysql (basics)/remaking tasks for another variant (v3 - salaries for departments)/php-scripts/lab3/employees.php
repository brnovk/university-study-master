...
<head>
	<meta charset="utf-8">
	<title>Лабораторная №3, Сотрудники</title>
	...
	<div class="container-fluid">
		...
		<?php
			try {
				...
				$sql = 'SELECT employeeLastName, (SELECT chairs.chairName FROM chairs 
					WHERE employees.chairId = chairs.id) AS chairName, post, homeAddress,
