<?php
	...
	if ($requestType === INPUT_POST || $requestType === INPUT_GET) {
		...
		if ($valid) {
			$res = addBuyer($fullName, $address, $phone);
			if (!is_null($res)) {
				$errors .= 'Ошибка добавления покупателя: '.$res.'<br>';
			} else {
...
<div class="masthead">
    <div class="site-center">
        <div class="cell">
            <h4>Работа 2, Добавление покупателя</h4>
        </div>
    </div>
</div>
<?php if (!empty($errors)): ?>
            ...
            <div class="col">
                <div class="col label">
                    <div style="margin: 10px;">
                        <a class="dowload" href="buyers.php">Назад</a>
                    </div>
                </div>
                <div class="col width-fit">
                    <div class="cell">
