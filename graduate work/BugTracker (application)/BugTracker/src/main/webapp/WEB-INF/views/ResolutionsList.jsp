...
<html>
<head>
	<title><s:message code="page.title.list.resolution"/></title>
	<!--[if IE]>
		...
		<div id="body">
			<div class="table-wrapper">
				<table id="myTable" class="tablesorter">
					<thead>
						<tr>
							<th><s:message code="resolution.name"/></th>
						</tr>
					</thead>
					<tbody>
						<c:forEach items="${resolutionList}" var="resolution">
							<tr>
								<td>
									<a href="<c:url value="/Admin/Resolutions/${resolution.id}"></c:url>">
