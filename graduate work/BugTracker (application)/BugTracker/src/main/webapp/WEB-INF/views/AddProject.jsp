...
<html>
<head>
	<title><s:message code="page.title.add.project"/></title>
	<!--[if IE]>
	...
	<div class="content">
		...
		<div id="body">
			<sf:form name="addProject" method="post" modelAttribute="project" 
				onsubmit="return threeFieldsValidation('addProject', 'name', 'nameError', 
					'description', 'descriptionError', 'builds[0].name', 'buildError');">
				<table class="table-edit-project">
					...
					<tr>
						<td class="label-td percent25"><s:message code="detail.project.create.build"/>:</td>
						<td class="percent50">
						 	<s:message code="detail.project.create.build.placeholder" var="createBuildPlaceholder"/>
						 	<sf:input path="builds[0].name" placeholder="${createBuildPlaceholder}"/>
						</td>
						<td class="err-td" id="buildError">
				...
				<table class="table-edit-button-wrapper">
					<tr>
						<td class="percent25">
						<input type="submit" value="<s:message code="add.project.submit"/>" 
							title='<s:message code="add.project.submit.title"/>' class="issueformbutton">
						</td>
						<td></td>
						<td></td>
					</tr>
