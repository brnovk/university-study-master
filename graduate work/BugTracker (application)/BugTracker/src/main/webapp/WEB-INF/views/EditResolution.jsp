...
<html>
<head>
	<title><s:message code="page.title.edit.resolution"/></title>
	<!--[if IE]>
	...
	<div class="content">
		...
		<div id="body">
			<sf:form name="editResolution" method="post" modelAttribute="resolution"
				onsubmit="return singleFieldsValidation('editResolution','name','resolutionError');">
				...
				<table class="table-edit-button-wrapper">
					<tr>
						<td class="percent25">
						<input type="submit" value="<s:message code="resolution.edit.submit"/>" 
							title='<s:message code="resolution.edit.submit.title"/>' class="issueformbutton">
						</td>
						<td></td>
						<td></td>
					</tr>
