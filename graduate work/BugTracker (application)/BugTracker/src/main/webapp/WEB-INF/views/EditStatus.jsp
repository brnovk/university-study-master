...
<html>
<head>
	<title><s:message code="page.title.edit.status"/></title>
	<!--[if IE]>
...
<div id="page-wrapper">
	...
	<div class="content">
		...
		<div id="body">
			<sf:form name="editStatus" method="post" modelAttribute="status"
				onsubmit="return singleFieldsValidation('editStatus','name','statusError');">
				<table class="table-edit-etities">
					<tr>
						<td class="label-td percent25"><s:message code="status.name"/>:</td>
						<td class="percent50">
							<s:message code="status.placeholder" var="statusPlaceholder"/>
							<sf:input path="name" placeholder="${statusPlaceholder}"/>
						</td>
						<td class="err-td" id="statusError">
				...
				<table class="table-edit-button-wrapper">
					<tr>
						<td class="percent25">
							<input type="submit" value="<s:message code="status.edit.submit"/>" 
								title='<s:message code="status.edit.submit.title"/>' class="issueformbutton">
						</td>
						<td></td>
						<td></td>
					</tr>
