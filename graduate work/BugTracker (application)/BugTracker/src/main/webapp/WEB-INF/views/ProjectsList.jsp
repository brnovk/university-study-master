...
<html>
<head>
	<title><s:message code="page.title.list.project"/></title>
	<!--[if IE]>
		    				...
		    				switch(j) {
		    					...
		    					case 1:
		    						a.innerHTML = prop;
				    		 		...
				    		 		break;
		    					case 3: 
		    						cells[j-1].className = 'projectDescription overf maxwidth400';
				    		 	default:
			...
			<c:choose>
				<c:when test="${empty projectList}">
					<div class="not-found-block">
						<s:message code="projects.notfound.message"/>
					</div>
				</c:when>
				<c:otherwise>
							...
							<thead>
								<tr>
									<th class="header column">
										<s:message code="table.project.name"/>
									</th>
									<th class="header column">
										<s:message code="table.project.manager"/>
									</th>
									<th class="header column overf maxwidth400">
										<s:message code="table.project.description"/>
									</th>
								</tr>
							</thead>
							<tbody>
								<c:forEach items="${projectList}" var="project">
									<tr>
										<td>
											<a href="<c:url value="/Admin/Projects/${project.id}"></c:url>">
										...
										<td class="projectDescription overf maxwidth400">
