...
<html>
<head>
	<title><s:message code="page.title.edit.user.self"/></title>
	<!--[if IE]>
	...
	<div class="content">
		...
		<div id="body">
			<sf:form name="editUser" method="post" modelAttribute="user" 
				onsubmit="return fiveFieldsValidation('editUser', 'emailAddress', 'emailError', 'firstName', 
					'firstNameError', 'lastName', 'lastNameError', 'password', 'passwordError', 
				...
				<table class="table-edit-user">
					...
					<tr>
						...
						<td class="percent33">
							...
							<sf:password path="password" placeholder="${passwordPlaceholder}" id="pass"/>
						</td>
					...
					<tr>
						...
						<td class="err-td" id="passConfirmError"></td>
					</tr>
				</table>
				<table class="table-edit-button-wrapper">
					<tr>
						<td class="percent25">
							<input type="submit" value='<s:message code="profile.edit.self.submit"/>'
								title='<s:message code="profile.edit.self.submit.title"/>' 
