...
<html>
<head>
	<title><s:message code="page.title.edit.type"/></title>
	<!--[if IE]>
...
<div id="page-wrapper">
	...
	<div class="content">
		...
		<div id="body">
			<sf:form name="editType" method="post" modelAttribute="type"
				onsubmit="return singleFieldsValidation('editType','name','typeError');">
				...
				<table class="table-edit-button-wrapper">
					<tr>
						<td class="percent25">
						<input type="submit" value="<s:message code="type.edit.submit"/>" 
							title='<s:message code="type.edit.submit.title"/>' class="issueformbutton">
						</td>
						<td></td>
						<td></td>
					</tr>
