...
<html>
<head>
	<title><s:message code="page.title.add.priority"/></title>
	<!--[if IE]>
...
<div id="page-wrapper">
	...
	<div id="body">
		<sf:form name="addPriority" method="post" modelAttribute="priority"
			onsubmit="return singleFieldsValidation('addPriority','name','priorityError');">
			<table class="table-edit-etities">
				<tr>
					<td class="label-td percent25"><s:message code="priority.name"/>:</td>
					<td class="percent50">
						<s:message code="priority.placeholder" var="priorityPlaceholder"/>
						<sf:input path="name" placeholder="${priorityPlaceholder}"/>
					</td>
					<td class="err-td" id="priorityError">
			...
			<table class="table-edit-button-wrapper">
				<tr>
					<td class="percent25">
					<input type="submit" value="<s:message code="priority.add.submit"/>" 
						title='<s:message code="priority.add.submit.title"/>' class="issueformbutton">
					</td>
					<td></td>
					<td></td>
				</tr>
	...
	<div id="substrate-footer"></div></div>
</div>
<div id="footer">
