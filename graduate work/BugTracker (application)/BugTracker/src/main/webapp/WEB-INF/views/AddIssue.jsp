...
<html>
<head>
	<title><s:message code="page.title.add.issue"/></title>
	<!--[if IE]>
	...
	<div class="content">
		...
		<div id="body">
			<sf:form name="addissue" method="post" modelAttribute="issue" 
				onsubmit="return fourFieldsValidation('addissue','summary','summaryError', 'description',
					'descriptionError', 'project.id', 'projectError', 'buildFound.id', 'buildError');">
				<table class="table-edit-issue">
					<tr>
						...
						<td class="err-td" id="summaryError">
				...
				<table class="table-edit-button-wrapper">
					<tr>
						<td class="percent25">
							<input type="submit" value='<s:message code="add.issue.submit"/>'
								title='<s:message code="add.issue.submit.title"/>' class="issueformbutton">
						</td>
						<td></td>
						<td></td>
					</tr>
