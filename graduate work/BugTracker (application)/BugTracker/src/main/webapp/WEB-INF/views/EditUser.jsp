...
<html>
<head>
	<title><s:message code="page.title.edit.user"/></title>
	<!--[if IE]>
		...
		<div id="body">
			<sf:form name="editUser" method="post" modelAttribute="user" 
				...
				<table class="table-edit-button-wrapper">
					<tr>
						<td class="percent25">
							<input type="submit" value='<s:message code="profile.edit.other.submit"/>' 
								title='<s:message code="profile.edit.other.submit.title"/>' 
