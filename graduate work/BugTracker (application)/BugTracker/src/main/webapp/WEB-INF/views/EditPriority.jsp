...
<html>
<head>
	<title><s:message code="page.title.edit.priority"/></title>
	<!--[if IE]>
...
<div id="page-wrapper">
	...
	<div class="content">
		...
		<div id="body">
			<sf:form name="editPriority" method="post" modelAttribute="priority"
				onsubmit="return singleFieldsValidation('editPriority','name','priorityError');">
				...
				<table class="table-edit-button-wrapper">
					<tr>
						<td class="percent25">
						<input type="submit" value="<s:message code="priority.edit.submit"/>" 
							title='<s:message code="priority.edit.submit.title"/>' class="issueformbutton">
						</td>
						<td></td>
						<td></td>
					</tr>
