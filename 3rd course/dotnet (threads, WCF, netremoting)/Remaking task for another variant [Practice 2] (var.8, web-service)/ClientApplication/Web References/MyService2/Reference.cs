...
namespace ClientApplication.MyService2 {
    ...
    public partial class Service2 : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        private System.Threading.SendOrPostCallback DifferenceOctalNumbersOperationCompleted;
        ...
        /// <remarks/>
        public event DifferenceOctalNumbersCompletedEventHandler DifferenceOctalNumbersCompleted;
        
        /// <remarks/>
        public event AppointmentPluginCompletedEventHandler AppointmentPluginCompleted;
        
        /// <remarks/>
        [System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://tempuri.org/InterfaceService2/DifferenceOctalNumbers", RequestNamespace="http://tempuri.org/", ResponseNamespace="http://tempuri.org/", Use=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
        [return: System.Xml.Serialization.XmlElementAttribute(IsNullable=true)]
        public string DifferenceOctalNumbers([System.Xml.Serialization.XmlElementAttribute(IsNullable=true)] string s1, [System.Xml.Serialization.XmlElementAttribute(IsNullable=true)] string s2) {
            object[] results = this.Invoke("DifferenceOctalNumbers", new object[] {
                        s1,
                        s2});
        ...
        /// <remarks/>
        public void DifferenceOctalNumbersAsync(string s1, string s2) {
            this.DifferenceOctalNumbersAsync(s1, s2, null);
        }
        
        /// <remarks/>
        public void DifferenceOctalNumbersAsync(string s1, string s2, object userState) {
            if ((this.DifferenceOctalNumbersOperationCompleted == null)) {
                this.DifferenceOctalNumbersOperationCompleted = new System.Threading.SendOrPostCallback(this.OnDifferenceOctalNumbersOperationCompleted);
            }
            this.InvokeAsync("DifferenceOctalNumbers", new object[] {
                        s1,
                        s2}, this.DifferenceOctalNumbersOperationCompleted, userState);
        }
        
        private void OnDifferenceOctalNumbersOperationCompleted(object arg) {
            if ((this.DifferenceOctalNumbersCompleted != null)) {
                System.Web.Services.Protocols.InvokeCompletedEventArgs invokeArgs = ((System.Web.Services.Protocols.InvokeCompletedEventArgs)(arg));
                this.DifferenceOctalNumbersCompleted(this, new DifferenceOctalNumbersCompletedEventArgs(invokeArgs.Results, invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState));
            }
        }
    ...
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.0.30319.19408")]
    public delegate void DifferenceOctalNumbersCompletedEventHandler(object sender, DifferenceOctalNumbersCompletedEventArgs e);
    
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.0.30319.19408")]
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    public partial class DifferenceOctalNumbersCompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs {
        
        private object[] results;
        
        internal DifferenceOctalNumbersCompletedEventArgs(object[] results, System.Exception exception, bool cancelled, object userState) : 
