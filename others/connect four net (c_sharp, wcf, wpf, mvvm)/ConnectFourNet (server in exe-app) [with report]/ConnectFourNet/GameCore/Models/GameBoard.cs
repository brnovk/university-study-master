...
namespace ConnectNNet.GameCore.Models
{
	...
	public class GameBoard
	{
		...
		#region Константы		
		/// <summary>
		/// Массив смещений для рекурсивной функции определения выигрышной ситуации для клетки.
		/// </summary>
		...
		/// <summary>
		/// Количесто свободных клеток (для определения ничьи).
		/// </summary>
		...
		/// </summary>
		/// <param name="cellPos">Клетка хода.</param>
		/// <param name="vinSize">Длинна выигрышной комбинации.</param>
		/// <param name="lineCode">Индекс элемента в массиве смещений (для рекурсии).</param>
		/// <returns></returns>
